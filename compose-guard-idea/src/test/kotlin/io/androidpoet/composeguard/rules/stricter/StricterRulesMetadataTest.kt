...
class StricterRulesMetadataTest {
  ...
  // ===== Both stricter rules enabled by default =====
  ...
  // ===== Both stricter rules have documentation URLs =====
  ...
  // ===== Both stricter rules are in correct category =====
