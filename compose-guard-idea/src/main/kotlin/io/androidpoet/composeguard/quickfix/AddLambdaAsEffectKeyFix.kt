...
public class AddLambdaAsEffectKeyFix(
  ...
  override fun applyFix(project: Project, descriptor: ProblemDescriptor) {
    ...
    if (existingArgs.isEmpty()) {
      // No existing keys - add the lambda as the first key
      ...
      // Replace Unit with the lambda name
      ...
      val argList = effectCall.valueArgumentList
      if (argList != null) {
        // Find the position before the trailing lambda (if inline) or at the end
